...
Concerned with model-fit influential outliers: "accurate data points that lie at a distance from other data points, are not error or interesting outliers, and also affect substantive conclusions"

```{r}
# lb = quantile(dat$goal, 0.025)
# ub = quantile(dat$goal, 0.975)
# dat.c = dat[dat$goal > lb & dat$goal < ub, ]
# dat.c$goal_sc = scale(dat.c$goal)
```
