...
```{r}
mean(projects[projects$any_metaphor, ]$text_length_words)
mean(projects[projects$dom_journey, ]$text_length_words)
mean(projects[projects$dom_battle, ]$text_length_words)
mean(projects[projects$dom_journey, ]$journey_salience) * 1000
mean(projects[projects$dom_battle, ]$battle_salience) * 1000
mean(projects[projects$dom_journey, ]$journey_salience) * mean(projects[projects$dom_journey, ]$text_length_words)
mean(projects[projects$dom_battle, ]$battle_salience) * mean(projects[projects$dom_battle, ]$text_length_words)
```
