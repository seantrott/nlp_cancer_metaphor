...
```{r cars}
dat = read.csv('../../data/processed/gofundme_projects_new.csv')
...
In total, we have 950 iid samples to work with.
...
The Poisson distribution obviously does not fit the data well since p~0.
...
# add photos
mod.dur.length.goal.inst.photos <- glmmTMB(backers ~ photos_sc + inst + goal_sc + text_length_words_sc + duration_cat + (1|year), data = dat.b, family="nbinom2")

# add updates
mod.dur.length.goal.inst.photos.updates <- glmmTMB(backers ~ updates_sc + photos_sc + inst + goal_sc + text_length_words_sc + duration_cat + (1|year), data = dat.b, family="nbinom2")
...
anova(mod.dur.length.goal.inst, mod.dur.length.goal.inst.photos, test='Chisq')
anova(mod.dur.length.goal.inst.photos, mod.dur.length.goal.inst.photos.updates, test='Chisq')
```

```{r}
summary(mod.dur.length.goal.inst.photos.updates)
```

## Add metaphors

```{r}
mod.no_metaphor = glmmTMB(backers ~ no_metaphor + updates_sc + photos_sc + goal_sc + text_length_words_sc + duration_cat + inst + (1|year),
                        data = dat.b, family = "nbinom2")
mod.any_metaphor = glmmTMB(backers ~ any_metaphor + updates_sc + photos_sc + goal_sc + text_length_words_sc + duration_cat + inst + (1|year),
                        data = dat.b, family = "nbinom2")
mod.dom_journey = glmmTMB(backers ~ dom_journey + updates_sc + photos_sc + goal_sc + text_length_words_sc + duration_cat + inst + (1|year),
                        data = dat.b, family = "nbinom2")
mod.dom_journey.prod = glmmTMB(backers ~ journey_prod + dom_journey + updates_sc + photos_sc + goal_sc + text_length_words_sc + duration_cat + inst + (1|year),
                        data = dat.b, family = "nbinom2")
mod.dom_battle = glmmTMB(backers ~ dom_battle + updates_sc + photos_sc + goal_sc + text_length_words_sc + duration_cat + inst + (1|year),
                        data = dat.b, family = "nbinom2")
mod.dom_battle.prod = glmmTMB(backers ~ battle_prod + dom_battle + updates_sc + photos_sc + goal_sc + text_length_words_sc + duration_cat + inst + (1|year),
                        data = dat.b, family = "nbinom2")
mod.only_journey = glmmTMB(backers ~ only_journey + updates_sc + photos_sc + goal_sc + text_length_words_sc + duration_cat + inst + (1|year),
                        data = dat.b, family = "nbinom2")
mod.only_battle = glmmTMB(backers ~ only_battle + updates_sc + photos_sc + goal_sc + text_length_words_sc + duration_cat + inst + (1|year),
                        data = dat.b, family = "nbinom2")
mod.both_metaphor = glmmTMB(backers ~ both_metaphor + updates_sc + photos_sc + goal_sc + text_length_words_sc + duration_cat + inst + (1|year),
                        data = dat.b, family = "nbinom2")

anova(mod.dur.length.goal.inst.photos.updates, mod.no_metaphor)
anova(mod.dur.length.goal.inst.photos.updates, mod.any_metaphor)
anova(mod.dur.length.goal.inst.photos.updates, mod.dom_journey)
anova(mod.dom_journey, mod.dom_journey.prod)
anova(mod.dur.length.goal.inst.photos.updates, mod.dom_battle)
anova(mod.dom_battle, mod.dom_battle.prod)
anova(mod.dur.length.goal.inst.photos.updates, mod.only_journey)
anova(mod.dur.length.goal.inst.photos.updates, mod.only_battle)
anova(mod.dur.length.goal.inst.photos.updates, mod.both_metaphor)
```
