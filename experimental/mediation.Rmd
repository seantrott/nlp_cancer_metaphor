...
trials = read_csv("data_pilot_N200/data_clean.csv", col_types = cols()) %>%
  ...
  mutate(
    ...
    cond_anymet = as.integer(cond_metaphor %in% c("battle", "journey")),
...
```{r}
base.formula = formula(~ self_cancer + ff_cancer + gender + education + socioeconomic + past_donations.z + age.z)
```
