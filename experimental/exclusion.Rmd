...
pprint("Failed the second bot check question", trials$check1 != CHECK1_ANS)
...
```{r}
minimumTrialRT = 10000 # in Milliseconds
...
```{r}
keywords = c("metaphor", "metaphors", "framing", "manipulate", "manipulates", "manipulated", "manipulating", "worded", "wording", "phrased", "phrasing")
...
```{r}
trials[trials$purpose_flag != "", c("ppt", "purpose")]
```

TODO: Remove ppts here from manual inspection
